    ...
    >
      <div className="project-overview" key={_id} style={taskStyle}>
        <div className="card-body project-overview-body">
          <h5 className="card-title project-overview-title" >{title}</h5>
          <hr />
          <p className="card-text project-overview-description"><b>Desc:</b> <br/>{description}</p>
          <p className="card-text project-overview-description"><b>Assigned to:</b> <br/>{assigned[0][0].assigned}</p>
          
          <span className='bottom-task-card-overview'><hr/>
